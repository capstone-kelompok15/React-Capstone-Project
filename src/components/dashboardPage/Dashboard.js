        ...
        <nav className='nav'>
          <div>
            ...
            <div className='nav-list'>
              <a href='#' className='nav-item2 active2 mx-5'>
			          <img className="logo4 ps-2 me-2" src={dashboard} alt="Logo" />
                <span className='nav-item2-name'>Dashboard</span>
              </a>
              <a href='#' className='nav-item2 mx-5'>
			          <img className="logo4 ps-2 me-2" src={invoice} alt="Logo" />
                <span className='nav-item2-name'>Invoices</span>
              </a>
              <a href='#' className='nav-item2 mx-5'>
			          <img className="logo4 ps-2 me-2" src={payment} alt="Logo" />
                <span className='nav-item2-name'>Payments</span>
              </a>
              <a href='#' className='nav-item2 mx-5'>
			          <img className="logo4 ps-2 me-2" src={customer} alt="Logo" />
                <span className='nav-item2-name'>Customer</span>
              </a>
			        <a href='#' className='nav-item2 mx-5'>
			          <img className="logo4 ps-2 me-2" src={profile} alt="Logo" />
